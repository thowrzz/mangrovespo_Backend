...
urlpatterns = [
    ...
    # Auth — customer (OTP/Google)
    path('api/v1/auth/', include('customer_auth.urls')),

    # Auth — admin JWT (old path kept as alias so frontend doesn't break)
    path('api/v1/auth/', include('apps.notifications.auth_urls')),
